...
class _$_SessionId implements _SessionId {
  const _$_SessionId({required this.success, required this.sessionId});
  ...
  @override
  String toString() {
    return 'SessionId(success: $success, sessionId: $sessionId)';
  }
...
abstract class _SessionId implements SessionId {
  const factory _SessionId(
      {required final bool success,
      required final String sessionId}) = _$_SessionId;
