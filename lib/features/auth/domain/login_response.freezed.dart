...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool success, int statusCode, String message, String? sessionId});
}
...
class _$_LoginResponse implements _LoginResponse {
  ...
  @override
  String toString() {
    return 'LoginResponse(success: $success, statusCode: $statusCode, message: $message, sessionId: $sessionId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, success, statusCode, message, sessionId);
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final String? sessionId}) = _$_LoginResponse;
