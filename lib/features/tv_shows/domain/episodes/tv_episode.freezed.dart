...
class _$_TVEpisode implements _TVEpisode {
  ...
  @override
  String toString() {
    return 'TVEpisode(airDate: $airDate, episodeNumber: $episodeNumber, id: $id, name: $name, overview: $overview, productionCode: $productionCode, seasonNumber: $seasonNumber, stillPath: $stillPath, voteAverage: $voteAverage, voteCount: $voteCount)';
  }
...
abstract class _TVEpisode implements TVEpisode {
  const factory _TVEpisode(
      ...
      required final int voteCount}) = _$_TVEpisode;
