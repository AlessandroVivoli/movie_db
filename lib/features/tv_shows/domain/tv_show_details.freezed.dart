...
TVShowDetails _$TVShowDetailsFromJson(Map<String, dynamic> json) {
  return _TVShowDetails.fromJson(json);
}

/// @nodoc
mixin _$TVShowDetails {
  ...
  @JsonKey(ignore: true)
  $TVShowDetailsCopyWith<TVShowDetails> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TVShowDetailsCopyWith<$Res> {
  factory $TVShowDetailsCopyWith(
          TVShowDetails value, $Res Function(TVShowDetails) then) =
      _$TVShowDetailsCopyWithImpl<$Res, TVShowDetails>;
  @useResult
  $Res call(
      {String? backdropPath,
...
/// @nodoc
class _$TVShowDetailsCopyWithImpl<$Res, $Val extends TVShowDetails>
    implements $TVShowDetailsCopyWith<$Res> {
  _$TVShowDetailsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_TVShowDetailsCopyWith<$Res>
    implements $TVShowDetailsCopyWith<$Res> {
  factory _$$_TVShowDetailsCopyWith(
          _$_TVShowDetails value, $Res Function(_$_TVShowDetails) then) =
      __$$_TVShowDetailsCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? backdropPath,
...
/// @nodoc
class __$$_TVShowDetailsCopyWithImpl<$Res>
    extends _$TVShowDetailsCopyWithImpl<$Res, _$_TVShowDetails>
    implements _$$_TVShowDetailsCopyWith<$Res> {
  __$$_TVShowDetailsCopyWithImpl(
      _$_TVShowDetails _value, $Res Function(_$_TVShowDetails) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_TVShowDetails implements _TVShowDetails {
  const _$_TVShowDetails(
      ...
      required final List<TVSeason> seasons,
  ...
  factory _$_TVShowDetails.fromJson(Map<String, dynamic> json) =>
      _$$_TVShowDetailsFromJson(json);

  @override
  final String? backdropPath;
  final List<TVShowCreator> _createdBy;
  @override
  List<TVShowCreator> get createdBy {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.orignalLanguage, orignalLanguage) ||
                other.orignalLanguage == orignalLanguage) &&
  ...
  _$$_TVShowDetailsCopyWith<_$_TVShowDetails> get copyWith =>
      __$$_TVShowDetailsCopyWithImpl<_$_TVShowDetails>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_TVShowDetailsToJson(
      this,
    );
  }
}

abstract class _TVShowDetails implements TVShowDetails {
  const factory _TVShowDetails(
